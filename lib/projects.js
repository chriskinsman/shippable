...
Projects.prototype.list = function list(query, callback) {
    this._httpMethod.get('/projects', query, callback);
};
...
Projects.prototype.getBranchRunStatus = function getBranchRunStatus(projectId, callback) {
    this._httpMethod.get(util.format('/projects/%s/branchRunStatus', projectId), null, callback);
};
